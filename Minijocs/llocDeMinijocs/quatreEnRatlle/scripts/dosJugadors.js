...
function jugar(x){
  ...
  if(continuar){
    if(ronda == 1){
  //Processa la ronda de la creu
    ficarCreu(x);
    ronda = 2;
  }else if(ronda == 2){
  //Processa la ronda del cercla
    ficarCercla(x);
    ronda = 1;
  }
...
function ficarCercla(x){
  ...
  //Es desmarca perquè no es quedi la imatge del cercla marcada de per vida
  desmarcar(x);
