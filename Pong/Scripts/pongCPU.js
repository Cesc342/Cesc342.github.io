...
var vcpu = parseInt(localStorage.getItem("velocitatCPU"));
...
class CPU{
  ...
  draw(){
    this.c.fillRect(1075,this.y,25,100);
  }
}
...
function animació(){
  ...
  pil.context.clearRect(0,0,1100,1100);
    if(j1.y <= pil.y + 10 && j1.y + 105 >= pil.y + 5){
      ...
      j1.p += 1;
      h1.innerHTML = punts + "p";
    }else if(cpu.y <= pil.y + 10 && cpu.y + 105 >= pil.y + 5){
      pil.dx = -pil.dx;
      pil.dx += 0.3;
      pil.dy += 0.3;
      cpu.p += 1;
